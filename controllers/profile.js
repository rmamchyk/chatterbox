    ...
    return {
        ...
        getProfilePage: function(req, res){
            async.parallel([
                ...
                res.render('user/profile', {title: 'Chatterbox - Profile', user:req.user, data: res1, chat:res2});
            });
        },
        ...
        overviewPage: function(req, res){
            async.parallel([
                ...
                res.render('user/overview', {title: 'Chatterbox - Overview', user:req.user, data: result1, chat:result2});
            });
        },
