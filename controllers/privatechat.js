    ...
    return {
        ...
        getchatPage: function(req, res){
            async.parallel([
                ...
                // read all messages to display it on chat panel.
                function(callback){
                    Message.find({
                ...
                res.render('private/privatechat', {title: 'Chatterbox - Private Chat', user:req.user, 
                    data: result1, 
                    chat: result2, 
                    chats:result3, 
                    name: nameParams
        ...
        chatPostPage: function(req, res, next){
            ...
            async.waterfall([
                //get the user-receiver from database
                function(callback){
                    if(req.body.message){
